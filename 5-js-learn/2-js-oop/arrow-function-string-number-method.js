...
// const string = new String("min ga lar par");
// console.log(string)
// console.log(string.length)
// console.log(string.toUpperCase())
// console.log(string.toLowerCase())
// console.log(string.substr(0,3))
// console.log(string.search("ga"))
// console.log(string.search("z"))
// console.log(string.replace("ga","zzza"));
// console.log(string.replaceAll("a","b"));
// // const string = new String("       min ga lar par      ");
...
// console.log(fruits.indexOf("zzz"));

// original array change tl
// console.log(fruits.splice(0,2));
// original array ma change buu
...
// console.log(fruits);
// // spread syntax
// console.log("kzt" , ...arr , ...fruits ,  "nums" , ...nums)
...
// const newFruitArray = fruits.forEach((fruit,index) => console.log(fruit,index));
...
// });
// const arr = products.filter((product) => product.price < 50);
// const arr = products.filter((product) => product.id < 10);
// const arr = products.filter((product) => product.id == 5);
// const arr = products.filter((product) => product.id !== 5);
// const arr = products.filter((product) => product.id === 5 || product.id === 7 || product.id === 15 );
// const arr = products.filter((product) => product.id == 5);
// const arr = products.filter((product) => [1, 7, 5, 9].includes(product.id));
// const arr = products.filter((product) => ![1, 7, 5, 9].includes(product.id));
// console.table(arr);
